...
function M.GameSceneReq(userid, msg)
    ...
    _player:send("pdk.GAME_EnterGameAck", ack_msg)
    ...
    player_mgr:broadcast_but(_player.userid, "pdk.GAME_PlayerEnterAck", broad)
...
function M.GAME_PassCardReq(userid, msg)
    match:GAME_PassCardReq(userid, msg)
end
...
function M.register()
    M.tbl =
    {
        ...
        ["pdk.GAME_ReadyReq"] = M.GAME_ReadyReq,
        ["pdk.GAME_OutCardReq"] = M.GAME_OutCardReq,
        ["pdk.GAME_PassCardReq"] = M.GAME_PassCardReq,
    }
end
...
function M.dispatch(userid, name, msg)
    ...
    if f then
        ...
        error("pdk msg have no handler "..name)
    end
end
